...
class BamlAsyncClient:
    ...
    async def AnalyzeText(self, input: str,
        ...
        if 'on_tick' in baml_options:
            ...
            stream = self.stream.AnalyzeText(input=input,
    ...
    async def ExtractTasks(self, transcript: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractTasks", args={
...
class BamlStreamClient:
    ...
    def ExtractTasks(self, transcript: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.Ticket"], typing.List["types.Ticket"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractTasks", args={
            "transcript": transcript,
        })
        return baml_py.BamlStream[typing.List["stream_types.Ticket"], typing.List["types.Ticket"]](
          result,
...
class BamlHttpRequestClient:
    ...
    async def AnalyzeText(self, input: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="AnalyzeText", args={
            "input": input,
        }, mode="request")
        return result
    async def ExtractResume(self, resume: str,
    ...
    async def ExtractTasks(self, transcript: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractTasks", args={
            "transcript": transcript,
        }, mode="request")
        return result
