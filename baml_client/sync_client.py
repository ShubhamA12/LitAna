...
class BamlSyncClient:
    ...
    def DecideOpponentMove(self, state: types.GameState,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="DecideOpponentMove", args={
                "state": state,
            })
...
class BamlStreamClient:
    ...
    def DecideOpponentMove(self, state: types.GameState,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.OpponentTurn, types.OpponentTurn]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="DecideOpponentMove", args={
            "state": state,
        })
        return baml_py.BamlSyncStream[stream_types.OpponentTurn, types.OpponentTurn](
          result,
...
class BamlHttpRequestClient:
    ...
    def DecideOpponentMove(self, state: types.GameState,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="DecideOpponentMove", args={
            "state": state,
        }, mode="request")
        return result
